<?php 
	// Fabrication
	$title="United Manufacturing | Full Service Metal Stamping & Tooling Facilities | Fabrication";
	$keywords="Fabrication, Metals, Metal, United mfg, United Manufacturing, Manufacturing metal, Fabricators, Ontario, Metal sheet, Fabricators metal, Fabrication steel, Metal fabricating, Metal fabricators, Customize, Customized, Metal fabrication, Fabrications, Manufacturing company, Manufacturing, Manufacturing industry, Customization, Sheet metal, Manufacturing companies, Manufacturing process";
...
?>
	<h2 style="padding-top:10px;">Fabrication</h2>
	...
	<div style="padding-top:10px;"class="structure">
		...
		<p class="text">
			For a detailed quotation, or inquires please email  <a href="mailto:info@umcmfg.com?subject=Website Inquiry: Fabrication" target="_blank"class="popLink">info@umcmfg.com</a> or fax a drawing to 519-622-1152.
		</p>
		<div class="clearfix" style="height: 15px;"></div>
		
		<a href="mailto:info@umcmfg.com?subject=Website Inquiry: Fabrication" target="_blank" ><img src="images/ask.png" class="askButton" style="padding-bottom:3px;"/>	</a>
		<div class="clearfix" style="height: 15px;"></div>

<?php 
	// Bend or Multiple Bend
	$title="United Manufacturing | Full Service Metal Stamping & Tooling Facilities | Specialized Precision Bends and Multiple Bends";
	$keywords="Manufacturing metal, Metal stamping, Stamping on metal, Metal forming, Stamping steel, Bend, Metal, United mfg, Metal bend, Bender, Sheet Metal, Metal Bend, Multiple bends, Fabrication, Bending, Metal work, Metal fabricators, Bending pipe, Bending metal, Ontario";
	$description="UMC specializes in precision bends and multiple bends. Whether through a progressive tool or a multi-stage die, UMC can shape a flat piece of metal into a specific shape as per your specifics.";
	
	include './inc/header.inc';
?>
	<h2 style="padding-top:10px;">Bend or Multiple Bend</h2>
	<div class="clearfix"></div>
	<div style="padding-top:10px;"class="structure">
		<p class="text" style="padding-top:5px;">
		UMC specializes in precision bends and multiple bends.  Whether through a progressive tool or a multi-stage die, UMC can shape a flat piece of metal into a specific shape as per your specifics.
		</p>
		<div class="clearfix" style="height: 15px;"></div>
		<p class="text">
			For a detailed quotation, or inquires please email  <a href="mailto:info@umcmfg.com?subject=Website Inquiry: Bend or Multiple Bend" target="_blank"class="popLink">info@umcmfg.com</a> or fax a drawing to 519-622-1152.
		</p>
		<div class="clearfix" style="height: 15px;"></div>
		
		<a href="mailto:info@umcmfg.com?subject=Website Inquiry: Bend or Multiple Bend" target="_blank" ><img src="images/ask.png" class="askButton" style="padding-bottom:3px;"/>	</a>
		<div class="clearfix" style="height: 15px;"></div>

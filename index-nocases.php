...
?>
	...
	<map name="locationMap"  >
		...
		<area shape="circle" coords="930,40,20" href="http://ca.linkedin.com/pub/grace-lisi/25/ab7/b58" alt="Linked In!" style="border: 0px; z-index:20;" target="_blank"  />
			...
			<span class="main-photo" style="background-image:url('images/profile-image.jpg')">
			</span>
	<!--	Featured Case Study Box 
			<span class="picturebox" style="background-image:url('images/featured.png')">
				<div class="featured-text">
					<h2 class="boxTitle" style="width: 200px;">
						Featured case study:
					</h2>
				</div>
			</span>
